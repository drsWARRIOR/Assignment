...
// Custom Editor Window for modifying the accessibility of each cell on the grid
public class GridEditorWindow : EditorWindow
{
    ...
    {
        GridEditorWindow win = GetWindow<GridEditorWindow>("Grid Setting");
        win.obj = obj;
    ...
    void OnGUI()
    {
        ...
        // Update the data before modifying
        obj.Update();

        EditorGUILayout.LabelField("Grid Editor", EditorStyles.boldLabel);// title of the window
